package com.pierremaurand.book.book;

import com.pierremaurand.book.common.PageResponse;
import com.pierremaurand.book.exception.OperationNotPermittedException;
import com.pierremaurand.book.file.FileStorageService;
import com.pierremaurand.book.history.BookTransactionHistory;
import com.pierremaurand.book.history.BookTransactionHistoryRepository;
...
import static com.pierremaurand.book.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public PageResponse<BorrowedBookResponse> findAllReturnedBooks(int page, int size, Authentication connectedUser) {
        //User user = (User) connectedUser.getPrincipal();
        Pageable pageable = PageRequest.of(page, size, Sort.by("createdDate").descending());
        Page<BookTransactionHistory> books = transactionHistoryRepository.findAllReturnedBooks(pageable, connectedUser.getName());
    ...
    public Integer returnBorrowedBook(Integer bookId, Authentication connectedUser) {
        ...
        BookTransactionHistory bookTransactionHistory = transactionHistoryRepository.findByBookIdAndUserId(bookId, connectedUser.getName())
                .orElseThrow(() -> new OperationNotPermittedException("Your did not borrow this book"));
